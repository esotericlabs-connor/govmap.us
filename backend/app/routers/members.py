...
async def member_detail(bioguide_id: str, db: AsyncSession = Depends(get_db)) -> dict:
    ...
    return {
        ...
        "finance": {
            ...
            "contributions": finance_row.contributions,
            "individual_contributions": finance_row.individual_contributions,
            "individual_itemized": finance_row.individual_itemized,
            "individual_unitemized": finance_row.individual_unitemized,
            ...
            "candidate_contribution": finance_row.candidate_contribution,
            "other_receipts": finance_row.other_receipts,
            "loans": finance_row.loans,
            "operating_expenditures": finance_row.operating_expenditures,
            "refunded_individual": finance_row.refunded_individual,
